...
const nl: BaseTranslation = {
	...
	HAIR: {
		...
		CONTENT: {
			INSPECTION_1: "Bedankt voor uw interesse in onze organisatie. Wij hebben uw aanvraag en foto's in goede orde ontvangen.",
			INSPECTION_2:
	...
	HAIR_APPOINTMENT: {
		...
		APPOINTMENT_TIME:
			'Wij bevestigen hierbij graag uw afspraak op <>{0:Date|datetime} te {1:string}<>. Dit consult is volledig vrijblijvend.',
		LOCATIONS: ['Lelystad'],
