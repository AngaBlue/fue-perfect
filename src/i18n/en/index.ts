...
const en: Translation = {
	...
	HAIR: {
		...
		CONTENT: {
			INSPECTION_1: 'Thank you for the interest you have shown in our organization, we have received your request + photos in good order.',
			INSPECTION_2:
		...
		TECHNIQUE: ['FUE Hair Transplant', 'DHI Hair Transplant', 'FUE + DHI Hair Transplant', 'FUE Beard Transplant', 'DHI Beard Transplant'],
